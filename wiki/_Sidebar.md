...
- [Installing the Application](https://github.com/richbl/go-ble-sync-cycle/wiki/Installation:-Installing-the-Application)
...
- [Running the Application](https://github.com/richbl/go-ble-sync-cycle/wiki/Basic-Usage:-Running-the-Application)
    - [GUI Mode](https://github.com/richbl/go-ble-sync-cycle/wiki/Basic-Usage:-GUI-Mode)
    - [CLI Mode](https://github.com/richbl/go-ble-sync-cycle/wiki/Basic-Usage:-CLI-Mode)
...
- [Anatomy of a BSC TOML File](https://github.com/richbl/go-ble-sync-cycle/wiki/Basic-Usage:-Anatomy-of-a-BSC-TOML-File)
    - [The App Section](https://github.com/richbl/go-ble-sync-cycle/wiki/Basic-Usage:-Anatomy-of-a-BSC-TOML-File#the-app-section)
    - [The BLE Section](https://github.com/richbl/go-ble-sync-cycle/wiki/Basic-Usage:-Anatomy-of-a-BSC-TOML-File#the-ble-section)
    - [The Speed Section](https://github.com/richbl/go-ble-sync-cycle/wiki/Basic-Usage:-Anatomy-of-a-BSC-TOML-File#the-speed-section)
    - [The Video Section](https://github.com/richbl/go-ble-sync-cycle/wiki/Basic-Usage:-Anatomy-of-a-BSC-TOML-File#the-video-section)
    - [The Video On-Screen Display Section](https://github.com/richbl/go-ble-sync-cycle/wiki/Basic-Usage:-Anatomy-of-a-BSC-TOML-File#the-video-on-screen-display-section)
