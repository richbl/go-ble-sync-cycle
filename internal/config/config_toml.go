...
[video.OSD]
  ...
  align_x = "{{.Video.OnScreenDisplay.AlignX}}"{{pad (printf "align_x = \"%s\"" .Video.OnScreenDisplay.AlignX)}}# The horizontal position of the OSD (alignLeft, alignCenter, alignRight)
  align_y = "{{.Video.OnScreenDisplay.AlignY}}"{{pad (printf "align_y = \"%s\"" .Video.OnScreenDisplay.AlignY)}}# The vertical position of the OSD (alignTop, alignCenter, alignBottom)  	
